...
function draw() {
  ...
  textSize(82);
  textFont(myFont)
  text("HIGHWAY",width/2,height/2-85);
  textSize(20);
  text("Do you really think the fastest thing you can do is running?",width/2,height/2);
  text("Discover the rhythm of your body actions",width/2,height/2+30);
  textSize(25);
  text("ARE YOU READY?",width/2,height/2+100);
  textSize(18);
  fill(100);
  text("Keep the mouse pressed until you reach the speed",width/2,height/2+130);
  }
