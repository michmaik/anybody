...
function preload() {
  ...
  myFont2 = loadFont('file/font/goudyregular.ttf')
...
function draw() {
 ...
 //lettere
  ...
  textSize(82);
  textFont(myFont2)
  text("SYMPHONY",width/2,height/2-85);
  textSize(20);
  text("Are you conscious about all the activities that your body is ",width/2,height/2);
  text("incessantly repeating to keep you alive?",width/2,height/2+30);
  textSize(25);
  text("The power of your body is on your finger.",width/2,height/2+100);
  textSize(18);
  fill(100);
  text("Click the mouse to start & Press the keyboard on rythm",width/2,height/2+130);
  }
  if (mouseIsPressed){
  testo=false;}
